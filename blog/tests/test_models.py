...
class ArticleModelTest(TestCase):
    ...
    def test_was_updated_recently_with_new_article(self):
        """
        was_updated_recently() returns True for articles whose updated_at is within the last day.
        """
        self.assertIs(self.article.was_updated_recently(), True)

    def test_was_updated_recently(self):
        """
        was_updated_recently() returns Flase for articles whose updated_at is older than 1 day..
        """
